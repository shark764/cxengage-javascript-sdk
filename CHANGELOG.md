...
## [10.2.2] - 2021-08-13
## Fixed
- CXV1-24431 - Handle error for Salesforce Classic set height initiation

## [10.2.1] - 2021-07-26
## Fixed
- CXV1-24431 - Handle error for Salesforce Lightning set height initiation
...
## [10.1.4] - 2021-07-07
## Fixed
- CXV1-24132 - revert changes done in 10.1.3
...
## [10.1.0] - 2021-05-20
## Changed
- CXV1-26870 - Media File Upload changes to universal create api
...
## [10.0.3] - 2021-04-16
## Fixed
- CXV1-21520 - Error 4002 generated because of failed interaction: set level of 4002 error to "warn"

## [10.0.2] - 2021-04-16
## Fixed
- CXV1-24295 - Fixed Salesforce Lightning contact phone numbers not enabling for click to dial when agent goes ready.
- CXV1-24295 - Added functionality to disable contact phone numbers when SDK is first initialized.

## [10.0.1] - 2021-04-14
## Fixed
- CXV1-24274 - Fixed code docs typos
