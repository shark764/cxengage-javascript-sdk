...
(def sdk-topics {
                 ...
                 :add-group-member-response "cxengage/entities/add-group-member-response"
                 :remove-group-member-response "cxengage/entities/remove-group-member-response"
                 ...
                 :add-skill-member-response "cxengage/entities/add-skill-member-response"
                 :remove-skill-member-response "cxengage/entities/remove-skill-member-response"
                 :update-skill-member-response "cxengage/entities/update-skill-member-response"
